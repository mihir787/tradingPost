class Seed
  ...
  def generate_proposed_trades
    ProposedTrade.create(status: 0, item_id: 1, user_id: 2)
    ProposedTrade.create(status: 1, item_id: 2, user_id: 3)
    ProposedTrade.create(status: 2, item_id: 3, user_id: 4)
    ProposedTrade.create(status: 0, item_id: 4, user_id: 5)
    ProposedTrade.create(status: 1, item_id: 5, user_id: 2)

    ProposedTrade.create(status: 0, item_id: 6, user_id: 1)
    ProposedTrade.create(status: 1, item_id: 7, user_id: 3)
    ProposedTrade.create(status: 2, item_id: 8, user_id: 4)
    ProposedTrade.create(status: 0, item_id: 9, user_id: 5)
    ProposedTrade.create(status: 1, item_id: 10, user_id: 1)

    ProposedTrade.create(status: 0, item_id: 11, user_id: 1)
    ProposedTrade.create(status: 1, item_id: 12, user_id: 2)
    ProposedTrade.create(status: 2, item_id: 13, user_id: 4)
    ProposedTrade.create(status: 0, item_id: 14, user_id: 5)
    ProposedTrade.create(status: 1, item_id: 15, user_id: 1)

    ProposedTrade.create(status: 0, item_id: 16, user_id: 1)
    ProposedTrade.create(status: 1, item_id: 17, user_id: 2)
    ProposedTrade.create(status: 2, item_id: 18, user_id: 3)
    ProposedTrade.create(status: 0, item_id: 19, user_id: 5)
    ProposedTrade.create(status: 1, item_id: 20, user_id: 1)

    ProposedTrade.create(status: 0, item_id: 21, user_id: 1)
    ProposedTrade.create(status: 1, item_id: 22, user_id: 2)
    ProposedTrade.create(status: 2, item_id: 23, user_id: 3)
    ProposedTrade.create(status: 0, item_id: 24, user_id: 4)
    ProposedTrade.create(status: 1, item_id: 25, user_id: 1)
  end
